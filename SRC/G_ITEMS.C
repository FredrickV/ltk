        ...
        */
                        ...
                        && ent->client->pers.inventory[ITEM_INDEX(item)] <= 1 )
        {
                        ...
                        if ( ent->client->unique_weapon_total > unique_weapons->value && !allweapon->value ) 
                        {
                                ...
                                safe_cprintf(ent, PRINT_HIGH, "One of your guns is dropped with the bandolier.\n");
                        }
                }
        Drop_Spec (ent, item);
...
//        int             index;
       ...
       // ent->solid = SOLID_NOT;
		...
		other->client->pers.inventory[ITEM_INDEX(FindItem(CAPTURE_NAME))] ++;

		Coop_SpawnBriefcaseSprite (other);
...
/* width */             2,
				...
				// Paril, Cooperative Briefcase for Capture
/*QUAKED briefcase (.3 .3 1) (-16 -16 -16) (16 16 16)
*/
        {
                "coop_briefcase", 
                Pickup_Briefcase,
