...
////////////////////////////////////////////////////////////////////////
/*
 * $Header: /Action/LTK/SRC/ACESRC/acebot_spawn.c,v 1.1 2007/01/21 21:04:07 Fredrick Exp $
 *
 * $Log: acebot_spawn.c,v $
...
void ACESP_PutClientInServer (edict_t *bot, qboolean respawn, int team)
{
	...
	gclient_t	*client;
	//int		i, counter; not used Fred
	int i; // But i was Fred
...
//AQ2 ADD
{
       ...
       client->mk23_max = 0;
		...
		wchoice = gamemode->value;
        echoice = gamemode->value;
		...
		case 6: //KNIFE_NAME
            ACEAI_Cmd_Choose( bot, KNIFE_NAME);
			break;
