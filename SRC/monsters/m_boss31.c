...
void jorg_firebullet_right (edict_t *self)
{
	...
	monster_fire_bullet (self, start, forward, 6, 4, DEFAULT_BULLET_HSPREAD, DEFAULT_BULLET_VSPREAD, MZ2_JORG_MACHINEGUN_R1, MOD_UNKNOWN);
}	
...
void jorg_firebullet_left (edict_t *self)
{
	...
	monster_fire_bullet (self, start, forward, 6, 4, DEFAULT_BULLET_HSPREAD, DEFAULT_BULLET_VSPREAD, MZ2_JORG_MACHINEGUN_L1, MOD_UNKNOWN);
}	
