...
/* 
 ============= 
 SV_Physics_Bounce 
 bounce movement. When onground, do nothing. 
 This is a copy of SV_Physics_Toss() modified to provide more realistic 
 bounce physics
 ============= 
*/ 
...
// if onground, return without moving 
        ...
        // SV_PushEntity might have called touch() functions so its possible we disappeared 
                ...
                // find component of velocity in direction of normal 
                        VectorScale (trace.plane.normal, DotProduct (trace.plane.normal, ent->velocity), normalVel); 
...
//                              separately 
                                temp[2] = 0; 
                                if ((VectorLength (temp) < 20) && (ent->velocity[2] < ent->gravity * sv_gravity->value * FRAMETIME * 1.5)) 
                                { 
